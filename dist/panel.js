...
exports.BrainDumpPanel = void 0;
const vscode = __importStar(require("vscode"));
const aiService_1 = require("./aiService");
class BrainDumpPanel {
    static createOrShow(extensionUri) {
        ...
        const panel = vscode.window.createWebviewPanel('brainDumpToCode', 'Brain Dump to Code', column, {
            enableScripts: true,
    ...
    constructor(panel, extensionUri) {
        ...
        this._panel.webview.onDidReceiveMessage(async (message) => {
            if (message.command === 'generate') {
                const code = await (0, aiService_1.getCodeFromBrainDump)(message.text, message.language);
    ...
    async _insertIntoActiveEditor(code) {
...
exports.BrainDumpPanel = BrainDumpPanel;
